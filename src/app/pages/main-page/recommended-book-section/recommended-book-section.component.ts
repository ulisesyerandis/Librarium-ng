...
export class RecommendedBookSectionComponent implements OnInit 
{
  ...
  [
    ...
    {id: 4, name:'The Great Gatsby', author:'F. Scott Fitzgerald', year:1925, img: '/assets/img/The Great Gatsby 2.PNG'},
    {id: 5, name:'Moby-Dick', author:'Herman Melville', year:1851, img: '/assets/img/Moby-Dick.PNG'},
    {id: 6, name:'To the Lighthouse', author:'Virginia Woolf', year:1927, img: '/assets/img/To the Lighthouse.PNG'},
    {id: 7, name:'The Catcher in the Rye', author:'J.D. Salinger', year:1951, img: '/assets/img/The Catcher in the Rye.PNG'},
    {id: 8, name:'The Lord of the Rings', author:'J.R.R. Tolkien', year:1954, img: '/assets/img/The Lord of the Rings 2.PNG'},
    {id: 9, name:'Brave New World', author:' Aldous Huxley', year:1932, img: '/assets/img/Brave New World 1.PNG'},
    ] 
 price1: number = 99.0;
